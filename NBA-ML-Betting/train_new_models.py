#!/usr/bin/env python3
"""
Train only the new spread and ML models.
This script focuses on the newly created models for spread and ML predictions.
"""
...
def main():
    """Main training function for new models only."""
    print("NBA Betting - New Model Training Suite")
    print("=" * 60)
    ...
    # Define only the new training scripts
    new_training_scripts = [
    ...
    print(f"Training {len(new_training_scripts)} new models...")
    
    # Run each training script
    for script, description in new_training_scripts:
        run_training_script(script, description)
    
    print(f"\n{'='*60}")
    print("All new model training completed!")
